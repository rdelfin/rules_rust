...
def rules_rust_test_prostgen_fetch_remote_crates():
    """This function defines a collection of repos and should be called in a WORKSPACE file"""
    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__anyhow__1_0_38",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.anyhow-1.0.38.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__async_stream__0_3_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.async-stream-0.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__async_stream_impl__0_3_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.async-stream-impl-0.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__async_trait__0_1_42",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.async-trait-0.1.42.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.autocfg-1.0.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__base64__0_13_0",
        url = "https://crates.io/api/v1/crates/base64/0.13.0/download",
        type = "tar.gz",
        sha256 = "904dfeac50f3cdaba28fc6f57fdcddb75f49ed61346676a78c4ffe55877802fd",
        strip_prefix = "base64-0.13.0",
        build_file = Label("//test/prostgen/raze/remote:BUILD.base64-0.13.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__bytes__1_0_1",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.bytes-1.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.cfg-if-1.0.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__either__1_6_1",
        url = "https://crates.io/api/v1/crates/either/1.6.1/download",
        type = "tar.gz",
        sha256 = "e78d4f1cc4ae33bbfc157ed5d5a5ef3bc29227303d595861deb238fcec4e9457",
        strip_prefix = "either-1.6.1",
        build_file = Label("//test/prostgen/raze/remote:BUILD.either-1.6.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__fnv__1_0_7",
        url = "https://crates.io/api/v1/crates/fnv/1.0.7/download",
        type = "tar.gz",
        sha256 = "3f9eec918d3f24069decb9af1554cad7c880e2da24a9afd88aca000531ab82c1",
        strip_prefix = "fnv-1.0.7",
        build_file = Label("//test/prostgen/raze/remote:BUILD.fnv-1.0.7.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__futures_channel__0_3_13",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.futures-channel-0.3.13.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.futures-core-0.3.13.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__futures_sink__0_3_13",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.futures-sink-0.3.13.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__futures_task__0_3_13",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.futures-task-0.3.13.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.futures-util-0.3.13.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__getrandom__0_2_2",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.getrandom-0.2.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__h2__0_3_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.h2-0.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__hashbrown__0_9_1",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.hashbrown-0.9.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__http__0_2_3",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.http-0.2.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.http-body-0.4.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__httparse__1_3_5",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.httparse-1.3.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.httpdate-0.3.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__hyper__0_14_4",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.hyper-0.14.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__indexmap__1_6_1",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.indexmap-1.6.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.itertools-0.9.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__itoa__0_4_7",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.itoa-0.4.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.lazy_static-1.4.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__libc__0_2_86",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.libc-0.2.86.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.log-0.4.14.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__memchr__2_3_4",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.memchr-2.3.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__mio__0_7_9",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.mio-0.7.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.miow-0.3.6.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__ntapi__0_3_6",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.ntapi-0.3.6.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__percent_encoding__2_1_0",
        url = "https://crates.io/api/v1/crates/percent-encoding/2.1.0/download",
        type = "tar.gz",
        sha256 = "d4fd5641d01c8f18a23da7b6fe29298ff4b55afcccdf78973b24cf3175fee32e",
        strip_prefix = "percent-encoding-2.1.0",
        build_file = Label("//test/prostgen/raze/remote:BUILD.percent-encoding-2.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__pin_project__1_0_5",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.pin-project-1.0.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__pin_project_internal__1_0_5",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.pin-project-internal-1.0.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.pin-project-lite-0.2.4.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__pin_utils__0_1_0",
        url = "https://crates.io/api/v1/crates/pin-utils/0.1.0/download",
        type = "tar.gz",
        sha256 = "8b870d8c151b6f2fb93e84a13146138f05d02ed11c7e7c54f8826aaaf7c9f184",
        strip_prefix = "pin-utils-0.1.0",
        build_file = Label("//test/prostgen/raze/remote:BUILD.pin-utils-0.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__ppv_lite86__0_2_10",
        url = "https://crates.io/api/v1/crates/ppv-lite86/0.2.10/download",
        type = "tar.gz",
        sha256 = "ac74c624d6b2d21f425f752262f42188365d7b8ff1aff74c82e45136510a4857",
        strip_prefix = "ppv-lite86-0.2.10",
        build_file = Label("//test/prostgen/raze/remote:BUILD.ppv-lite86-0.2.10.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.proc-macro2-1.0.24.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.prost-0.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.prost-derive-0.7.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.quote-1.0.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.rand-0.8.3.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__rand_chacha__0_3_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.rand_chacha-0.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__rand_core__0_6_2",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.rand_core-0.6.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__rand_hc__0_3_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.rand_hc-0.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__slab__0_4_2",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.slab-0.4.2.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__socket2__0_3_19",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.socket2-0.3.19.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__syn__1_0_60",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.syn-1.0.60.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tokio-1.2.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tokio_macros__1_1_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tokio-macros-1.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tokio_stream__0_1_3",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tokio-stream-0.1.3.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tokio_util__0_6_3",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tokio-util-0.6.3.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tonic__0_4_0",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tonic-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tower-0.4.5.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tower-layer-0.3.1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tower_service__0_3_1",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tower-service-0.3.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tracing-0.1.25.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tracing_attributes__0_1_13",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tracing-attributes-0.1.13.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__tracing_core__0_1_17",
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tracing-core-0.1.17.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.tracing-futures-0.2.5.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__try_lock__0_2_3",
        url = "https://crates.io/api/v1/crates/try-lock/0.2.3/download",
        type = "tar.gz",
        sha256 = "59547bce71d9c38b83d9c0e92b6066c4253371f15005def0c30d9657f50c7642",
        strip_prefix = "try-lock-0.2.3",
        build_file = Label("//test/prostgen/raze/remote:BUILD.try-lock-0.2.3.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__unicode_xid__0_2_1",
        url = "https://crates.io/api/v1/crates/unicode-xid/0.2.1/download",
        type = "tar.gz",
        sha256 = "f7fe0bb3479651439c9112f72b6c505038574c9fbb575ed1bf3b797fa39dd564",
        strip_prefix = "unicode-xid-0.2.1",
        build_file = Label("//test/prostgen/raze/remote:BUILD.unicode-xid-0.2.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.want-0.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__wasi__0_10_2_wasi_snapshot_preview1",
        url = "https://crates.io/api/v1/crates/wasi/0.10.2+wasi-snapshot-preview1/download",
        type = "tar.gz",
        sha256 = "fd6fbd9a79829dd1ad0cc20627bf1ed606756a7f77edff7b66b7064f9cb327c6",
        strip_prefix = "wasi-0.10.2+wasi-snapshot-preview1",
        build_file = Label("//test/prostgen/raze/remote:BUILD.wasi-0.10.2+wasi-snapshot-preview1.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__winapi__0_3_9",
        url = "https://crates.io/api/v1/crates/winapi/0.3.9/download",
        type = "tar.gz",
        sha256 = "5c839a674fcd7a98952e593242ea400abe93992746761e38641405d28b00f419",
        strip_prefix = "winapi-0.3.9",
        build_file = Label("//test/prostgen/raze/remote:BUILD.winapi-0.3.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/prostgen/raze/remote:BUILD.winapi-i686-pc-windows-gnu-0.4.0.bazel"),
    )

    maybe(
        http_archive,
        name = "rules_rust_test_prostgen__winapi_x86_64_pc_windows_gnu__0_4_0",
        url = "https://crates.io/api/v1/crates/winapi-x86_64-pc-windows-gnu/0.4.0/download",
        type = "tar.gz",
        sha256 = "712e227841d057c1ee1cd2fb22fa7e5a5461ae8e48fa2ca79ec42cfc1931183f",
        strip_prefix = "winapi-x86_64-pc-windows-gnu-0.4.0",
        build_file = Label("//test/prostgen/raze/remote:BUILD.winapi-x86_64-pc-windows-gnu-0.4.0.bazel"),
    )
