...
def rules_rust_proto_fetch_remote_crates():
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__autocfg__1_0_1",
        url = "https://crates.io/api/v1/crates/autocfg/1.0.1/download",
        type = "tar.gz",
        sha256 = "cdb031dd78e28731d87d56cc8ffef4a8f36ca26c38fe2de700543e627f8a464a",
        strip_prefix = "autocfg-1.0.1",
        build_file = Label("//proto/raze/remote:autocfg-1.0.1.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__crossbeam_queue__0_2_3",
        ...
        build_file = Label("//proto/raze/remote:crossbeam-queue-0.2.3.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__fnv__1_0_7",
        url = "https://crates.io/api/v1/crates/fnv/1.0.7/download",
        type = "tar.gz",
        sha256 = "3f9eec918d3f24069decb9af1554cad7c880e2da24a9afd88aca000531ab82c1",
        strip_prefix = "fnv-1.0.7",
        build_file = Label("//proto/raze/remote:fnv-1.0.7.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__hermit_abi__0_1_15",
        ...
        build_file = Label("//proto/raze/remote:hermit-abi-0.1.15.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__libc__0_2_77",
        ...
        build_file = Label("//proto/raze/remote:libc-0.2.77.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__memoffset__0_5_5",
        ...
        build_file = Label("//proto/raze/remote:memoffset-0.5.5.BUILD"),
    )

    maybe(
        http_archive,
        name = "rules_rust_proto__mio__0_6_22",
        ...
        build_file = Label("//proto/raze/remote:mio-0.6.22.BUILD"),
    )

    maybe(
        http_archive,
        name = "rules_rust_proto__mio_uds__0_6_8",
        ...
        build_file = Label("//proto/raze/remote:mio-uds-0.6.8.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__net2__0_2_35",
        ...
        build_file = Label("//proto/raze/remote:net2-0.2.35.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__redox_syscall__0_1_57",
        url = "https://crates.io/api/v1/crates/redox_syscall/0.1.57/download",
        type = "tar.gz",
        sha256 = "41cc0f7e4d5d4544e8861606a285bb08d3e70712ccc7d2b84d7c0ccfaf4b05ce",
        strip_prefix = "redox_syscall-0.1.57",
        build_file = Label("//proto/raze/remote:redox_syscall-0.1.57.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__tokio_uds__0_2_7",
        ...
        build_file = Label("//proto/raze/remote:tokio-uds-0.2.7.BUILD"),
    )
    ...
    maybe(
        http_archive,
        name = "rules_rust_proto__winapi__0_3_9",
        url = "https://crates.io/api/v1/crates/winapi/0.3.9/download",
        type = "tar.gz",
        sha256 = "5c839a674fcd7a98952e593242ea400abe93992746761e38641405d28b00f419",
        strip_prefix = "winapi-0.3.9",
        build_file = Label("//proto/raze/remote:winapi-0.3.9.BUILD"),
    )
